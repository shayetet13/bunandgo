...
- Production runs one worker process for every owner, with its own
  process-local H2 lane pool. There is no sharding or CPU pinning; the OS
  schedules the process across cores.
