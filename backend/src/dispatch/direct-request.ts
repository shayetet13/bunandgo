...
export type HotLineFetch = (info: RequestInfo | URL, init?: RequestInit) => Promise<Response>;
...
export function attachHotLineFetch<T extends object>(fetchLike: T, hotFetch: HotLineFetch, prewarmFetch?: HotLineFetch): T {
