		...
		const lanes = [
			{
				...
				sendRouteProfiles: new Map([
					["bot-a", { samples: [14, 15, 15], p50Ms: 15, p95Ms: 15, jitterMs: 0, lastAt: now, slowUntil: 0 }],
					["bot-b", { samples: [24, 25, 25], p50Ms: 25, p95Ms: 25, jitterMs: 0, lastAt: now, slowUntil: 0 }],
				]),
				lastSendOkAt: now,
				lastOkAt: now,
				inFlight: 0,
			},
			{
				...
				sendRttMs: 19,
				sendRouteProfiles: new Map([
					["bot-a", { samples: [20, 20, 21], p50Ms: 20, p95Ms: 21, jitterMs: 1, lastAt: now, slowUntil: 0 }],
					["bot-b", { samples: [16, 17, 17], p50Ms: 17, p95Ms: 17, jitterMs: 0, lastAt: now, slowUntil: 0 }],
				]),
				lastSendOkAt: now,
				lastOkAt: now,
				inFlight: 0,
