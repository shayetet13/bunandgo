...
describe("resetAllBotStatuses", () => {
	test("resets every non-offline bot, regardless of owner", () => {
...
describe("listBots / listBotsForUser", () => {
	test("every bot is listed, admin or not", () => {
